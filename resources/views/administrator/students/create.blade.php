...
<body>
    ...
    <form method="POST" action="{{ route('administrator.students.store') }}">
        ...
        <select name="teacher_id">
            <option value="">Selecione</option> @foreach ($teachers as $teacher)
        ...
        <textarea name="goal" rows="4" cols="30">{{ old('goal') }}</textarea><br><br>

        <label>Observações</label><br>
        <textarea name="observation" rows="4" cols="30">{{ old('observation') }}</textarea><br><br>
